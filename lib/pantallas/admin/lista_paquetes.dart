...
class PackagesView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      builder: (context, snapshot) {
        ...
        return Center(child: Text('Error al cargar los paquetes: ${snapshot.error}'));
  ...
  Future<List<dynamic>> a(id) async {
    ...
    var values = packsC.map((element) => element['id_paquetes_servicios']).toList();
    print(packs);
    print(packsC);
    print(values);
    return packs.where((element) => values.contains(element['id_paquete'])).toList();
  }
}
